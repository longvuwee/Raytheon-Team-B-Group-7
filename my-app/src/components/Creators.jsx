...
const teamMembers = [
  ...
  },
  {
    ...
    skills: ["Project Management", "Team Leadership", "Strategy", "Data Engineering", "Analytics", "Data Visualization"],
  ...
  },
  {
    ...
    skills: ["React", "HTML", "CSS", "JavaScript", "Data Engineering", "API Integration", "System Architecture", "Data Visualization", ],
    contribution: "Developed frontend components and internal tools that supported system visualization, data review, and performance monitoring for the Raytheon project. Built data pipelines that improved information flow between UI components and backend services. Designed clean user interfaces, optimized client-side performance, and contributed to system documentation to support maintainability and cross-team collaboration.",
    bio: "Frontend and data engineer with experience developing reliable, scalable interfaces and data processing workflows. Skilled in building secure, high-performance web applications, transforming complex data into actionable insights, and collaborating across engineering teams to deliver mission-critical solutions.",
